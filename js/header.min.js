!function () {
    function e() {
        h = window.innerWidth, u = window.innerHeight, w = {
            x: h / 2,
            y: u / 2
        }, v = document.getElementById("header"), v.style.height = u + "px", f = document.getElementById("header-canvas"), f.width = h, f.height = u, m = f.getContext("2d"), g = [];
        for (var e = 0; h > e; e += h / 20)for (var t = 0; u > t; t += u / 20) {
            var n = e + Math.random() * h / 20, o = t + Math.random() * u / 20, i = {
                x: n,
                originX: n,
                y: o,
                originY: o
    ...
    function i() {
        h = window.innerWidth, u = window.innerHeight, v.style.height = u + "px", f.width = h, f.height = u
    }
    ...
    function l(e) {
        if (e.active)for (var t in e.closest)m.beginPath(), m.moveTo(e.x, e.y), m.lineTo(e.closest[t].x, e.closest[t].y), m.strokeStyle = "rgba(156,217,249," + e.active + ")", m.stroke()
    }
    ...
    function d(e, t, n) {
        ...
        !function () {
            ...
            o.active && (m.beginPath(), m.arc(o.pos.x, o.pos.y, o.radius, 0, 2 * Math.PI, !1), m.fillStyle = "rgba(40,40,40," + o.active + ")", m.fill())
        }
    }
