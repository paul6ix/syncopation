...
function portfolioShow() {
    ...
    jQuery(".social-share li").delay(400).each(function (e, t) {
        var n = e * 80;
        jQuery(this).delay(n).animate({top: "0", opacity: 1}, 500, "easeOutBack")
    });
    jQuery(".entry-media").delay(600).animate({top: "0", opacity: 1}, 500, "easeOutQuart");
    jQuery(".entry-content").delay(1e3).animate({top: "0", opacity: 1}, 500, "easeOutQuart");
...
jQuery(window).load(function (e) {
        ...
        jQuery(".ajax-content").load(e + " #portfolio-single", function (r, i) {
            ...
            if (i == "success") {
                if (!t) {
                    ...
                    var s = 0;
                    jQuery("html,body").animate({scrollTop: jQuery(".ajax-section").offset().top - n}, 700, "easeOutQuart", function () {
                        if (s == 0) {
    ...
    jQuery("body").on("click", "a.load-content", function () {
        ...
        if (!t) {
            ...
            jQuery("html,body").animate({scrollTop: jQuery(".ajax-section").offset().top - e}, 700, "easeOutQuart")
        } else {
            var i = 0;
            jQuery("html,body").animate({scrollTop: jQuery(".ajax-section").offset().top - e}, 500, "easeOutQuart", function () {
                if (i == 0) {
                    var e = jQuery(".ajax-section").height();
                    jQuery(".ajax-section").css({"min-height": e + "px"});
    ...
    jQuery("body").on("click", ".close-project a", function () {
        ...
        jQuery(".ajax-content").animate({opacity: 0}, 500, function () {
            ...
            jQuery("html,body").animate({scrollTop: jQuery("#portfolio").offset().top - n}, 700, "easeOutQuart")
        });
        t = false;
        return false
    })
        ...
        if (form_class == "checkform") {
            ...
            if (!e) {
                ...
                if (form_action && form_action !== "") {
                    ...
                    jQuery.ajax({
                        type: "POST", url: form_action, data: t, success: function (e) {
...
function smoothShow() {
    ...
    jQuery(".skill").each(function () {
        ...
        if (jQuery(this).hasClass("anim")) {
            ...
            jQuery(this).addClass("anim");
            jQuery(this).find(".skill-bar .skill-active ").animate({width: t + "%"}, 2e3, "easeInOutQuart", function () {
                jQuery(this).find(".tooltip").delay(n).animate({top: "-28px", opacity: 1}, 500)
...
jQuery(window).load(function (e) {
    function i() {
        ...
        jQuery("#menu-responsive").animate({right: "-" + e + "px"}, 800, "easeInOutQuart")
    }
    ...
    jQuery("header").on("click", ".open-responsive-nav", function () {
        ...
        jQuery("#menu-responsive").css({height: t + "px", top: e + "px"});
    ...
    jQuery(".overlayinfo").each(function () {
        ...
        jQuery(this).css({marginTop: "-" + e + "px"})
    });
    if (jQuery().fitVids) {
        jQuery("body").fitVids()
    }
    ...
    if (jQuery().jPlayer && jQuery(".jp-interface").length) {
        jQuery(".jp-interface").each(function () {
            ...
            var t = e - 175;
            jQuery(this).find(".jp-progress-container").css({width: t + "px"})
        })
    }
